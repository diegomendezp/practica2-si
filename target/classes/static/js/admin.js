...
getActiveFilter = filters =>
  Object.keys(filters).filter(e => filters[e].applied)[0];
...
const displayServiceView = serviceId => {
  let service = filteredItems.find(e => e.id === serviceId);
